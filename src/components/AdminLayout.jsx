...
import { BarChart3, Users, FileText, Headphones, Settings, LogOut, Menu, X, Gavel, Crown, TrendingUp } from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const menuItems = [
    ...
    { label: 'Board Impact', icon: TrendingUp, path: '/admin/board-impact' },
